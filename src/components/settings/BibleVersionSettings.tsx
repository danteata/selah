...
export function BibleVersionSettings() {
    ...
    const handleEnableSearch = useCallback(async (versionId: string) => {
    ...
    }, [bibleVersionOptions, startSync, convex, downloadBibleVersion, refreshDownloadStatuses])
        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                    Download Bible versions and enable semantic search to find verses by meaning.
                </p>
            </div>
