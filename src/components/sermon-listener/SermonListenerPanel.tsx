...
export function SermonListenerPanel({
    ...
    return (
        <div className={`flex flex-col h-full ${compact ? 'gap-2' : 'gap-3'}`}>
            ...
            <div className={`flex items-center gap-2 ${compact ? 'p-1.5' : 'p-2'} rounded-lg ${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'}`}>
            ...
            {currentVerse && currentScripture && (
                <div className={`p-2 rounded-lg border ${isDarkMode ? 'bg-blue-900/30 border-blue-500/50' : 'bg-blue-50 border-blue-200'}`}>
                    ...
                    <div className={`text-xs ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} max-h-20 overflow-y-auto`}>
            ...
            {detectedVerses.length > 0 && (
                <div className={`p-2 rounded-lg ${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'}`}>
                    <div className="flex items-center justify-between mb-1.5">
                        ...
                        <button
                            onClick={reset}
                            className={`text-[10px] ${isDarkMode ? 'text-gray-400 hover:text-gray-200' : 'text-gray-500 hover:text-gray-700'}`}
                        >
                            Clear
                        </button>
                    </div>
            ...
            {(isListening || transcript || interimTranscript) && (
                <div className={`flex-1 min-h-0 p-2 rounded-lg ${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'} flex flex-col`}>
                    <div className="flex items-center justify-between mb-1">
                    ...
                    <div
                        ref={transcriptRef}
                        className={`flex-1 p-2 rounded text-xs overflow-y-auto ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}
                    >
