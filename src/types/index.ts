...
export const bibleVersionObjects: BibleVersion[] = [
    { id: 'KJV', name: 'King James Version', isDownloaded: true, copyrightContent: '' },
    { id: 'NIV', name: 'New International Version', isDownloaded: false, copyrightContent: '' },
    { id: 'NKJV', name: 'New King James Version', isDownloaded: false, copyrightContent: '' },
    { id: 'AMP', name: 'Amplified Bible', isDownloaded: false, copyrightContent: '' },
]
